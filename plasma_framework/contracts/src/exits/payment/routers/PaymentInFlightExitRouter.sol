...
contract PaymentInFlightExitRouter is IExitProcessor, Operated, OnlyWithValue, ReentrancyGuard {
     ...
     */
    function processInFlightExit(uint160 exitId, address token) internal nonReentrant {

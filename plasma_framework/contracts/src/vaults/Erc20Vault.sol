...
contract Erc20Vault is Vault, ReentrancyGuard {
    ...
    */
    function withdraw(address payable receiver, address token, uint256 amount) external onlyFromNonQuarantinedExitGame nonReentrant {
